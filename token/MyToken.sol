...
contract SuperUltraPowerCoin is MCoin { // CHANGE THIS. Update the contract name.
    ...
    */
    ...
    function SuperUltraPowerCoin() {
        ...
        name = "MCoin";                                   // Set the name for display purposes (CHANGE THIS)
        decimals = 18;                                               // Amount of decimals for display purposes (CHANGE THIS)
        symbol = "MNET";                                             // Set the symbol for display purposes (CHANGE THIS)
